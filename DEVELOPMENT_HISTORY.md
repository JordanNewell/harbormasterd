...
- **README**: Replaced references to non-existent files (`pad_pro_daemon.py`, `core/port-authority/pad_pro.py`).
...
**Environment**: E:\dev\projects\port-authority\  
...
class TLSManager:
    def __init__(self, domain="pa.local", ca_path=None):
        self.domain = domain
        self.ca_path = ca_path or Path.home() / ".harbormasterd" / "ca"
...
- `pad.log`: Daemon logs (when available)
...
📜 Certificate: C:\Users\jrnew\.harbormasterd\ca\pa.local.pem
🔑 Key: C:\Users\jrnew\.harbormasterd\ca\pa.local-key.pem
🔐 CA installed: ✅ True
```
...
*Development Environment: Windows 11, PowerShell 7.5.2, E:\dev\projects\port-authority\*  
