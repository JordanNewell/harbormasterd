#!/usr/bin/env python3
"""
Simple test script to verify Harbormasterd daemon connection
"""
...
def test_connection():
    """Test connection to Harbormasterd daemon"""
    ...
    try:
        ...
        if response.ok:
            data = response.json()
            print("✅ Harbormasterd daemon is CONNECTED and running!")
        ...
        print("❌ Harbormasterd daemon is NOT running")
